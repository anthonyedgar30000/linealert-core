(function(){
  ...
  function apply(){
    ...
    if(!maintenance||(!maintenance.active&&!maintenance.postMaintenanceObservation)){
      delete match.dataset.maintenanceOverlay;
      return;
    }
