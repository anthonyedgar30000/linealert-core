...
type OperatingModeAssessment = { configured_mode:string; source_kinds:string[]; scope:string; source_admitted:boolean; reason_code:string; authorized_action:boolean };
type TelemetrySnapshot = { connected:boolean; source_id:string; source_kind?:string; asset_id:string; read_only:boolean; reason_code:string; proxy_warning?:string; observation_sequence?:number; bridge_timestamp?:string; semantic_admission?:SemanticAdmission; claim_evidence?:ClaimEvidence; operating_mode?:OperatingModeAssessment; signals:Record<string,EvidenceSignal> };
