...
type ClaimAssessment = { claim_id:string; status:string; evidence_level:number; reason_code:string; authorized_action:boolean; observations:Array<{reason_code:string}> };
type ClaimEvidence = { assessments:Record<string,ClaimAssessment>; authorized_action:boolean };
type TelemetrySnapshot = { connected:boolean; source_id:string; asset_id:string; read_only:boolean; reason_code:string; proxy_warning?:string; observation_sequence?:number; bridge_timestamp?:string; semantic_admission?:SemanticAdmission; claim_evidence?:ClaimEvidence; signals:Record<string,EvidenceSignal> };
